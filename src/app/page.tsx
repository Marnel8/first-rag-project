...
export default function Home() {
  ...
  const [sources, setSources] = useState<MatchDocumentRow[]>([]);
              ...
              {sources.map((source, index) => (
                ...
                >
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">
                    ...
                    {(source.metadata as { source?: string; file_name?: string })?.source || (source.metadata as { source?: string; file_name?: string })?.file_name || 'Unknown'}
                  </p>
